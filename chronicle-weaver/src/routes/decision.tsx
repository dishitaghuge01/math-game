...
function ChoiceCard({
  ...
  return (
    <button
      disabled={disabled}
      onClick={onPick}
      className="group w-full min-w-0 text-left parchment-card p-5 hover:-translate-y-1 hover:shadow-[0_25px_45px_-15px_rgba(40,25,10,0.5)] transition-all disabled:opacity-60 disabled:cursor-wait"
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="font-heading text-base uppercase tracking-wider text-[color:var(--color-ink)] mb-1 break-words group-hover:text-[color:var(--color-ember)] transition-colors">
            {choice.label}
          </div>
